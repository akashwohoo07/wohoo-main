...
import { KIND_ICON } from "../../lib/icons.jsx";

const SEARCHABLE_TYPES = {
  hotel:      { kind: "stays",      icon: KIND_ICON.stays,      label: "Hotels & Stays" },
  restaurant: { kind: "eats",       icon: KIND_ICON.eats,       label: "Restaurants & Cafes" },
  activity:   { kind: "activities", icon: KIND_ICON.activities, label: "Activities" },
  place:      { kind: "sights",     icon: KIND_ICON.sights,     label: "Sights & Museums" },
};
